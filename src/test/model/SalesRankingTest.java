...
public class SalesRankingTest {
    ...
    public void testOrganize() {
        ...
        assertTrue(testRanking.getRanking().get(0).getPurchaseCount() > testRanking.getRanking().get(1)
                .getPurchaseCount());
        assertTrue(testRanking.getRanking().get(1).getPurchaseCount() > testRanking.getRanking().get(2)
                .getPurchaseCount());
    }
}
