...
public class SalesRanking {
    ...
    /*
     * MODIFIES: this, cloth
     * EFFECTS: Adds cloth to the itemList if an instance of an item with them same
     * ID does not already exist in the list;
     ...
     * MODIFIES: this
     * EFFECTS: Sorts itemList from the cloth with the highest purchase count to the
     * lowest
     */
